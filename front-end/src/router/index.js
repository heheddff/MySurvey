...
const Radio = () => import('@/views/actions/radio')
const Matrix = () => import('@/views/actions/matrix')
const Score = () => import('@/views/actions/score')
const Slider = () => import('@/views/actions/slider')
const Weight = () => import('@/views/actions/weight')
